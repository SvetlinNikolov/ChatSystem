        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            using (var scope = _scopeFactory.CreateScope())
            {
                ...
                try
                {
                    ...
                    var messages = cacheService.Get<IEnumerable<ChatMessage>>(CacheConstants.MessageCacheKey);
                    ...
                    if (messages != null && messages.Any())
                    {
                        ...
                        cacheService.RemoveFromCache<IEnumerable<ChatMessage>>(CacheConstants.MessageCacheKey);
